          ...
          bottomNavigationBar: Container(
            ...
            child: TabBar(
              indicator: const BoxDecoration(
                border: Border(
                  top: BorderSide(color: cyanColor, width: 4),
                ),
              ),
              onTap: changePage,
              ...
              tabs: [
                Tab(
                  child: Icon(
                    Icons.home_outlined,
                    color: currentPage == 0 ? cyanColor : Colors.black,
                  ),
                ),
                Tab(
                  child: Icon(
                    Icons.account_circle_outlined,
                    color: currentPage == 1 ? cyanColor : Colors.black,
                  ),
                ),
                Tab(
                  child: Icon(
                    Icons.shopping_cart_outlined,
                    color: currentPage == 2 ? cyanColor : Colors.black,
                  ),
                ),
                Tab(
                  child: Icon(
                    Icons.menu,
                    color: currentPage == 3 ? cyanColor : Colors.black,
                  ),
                ),
              ],
            ),
